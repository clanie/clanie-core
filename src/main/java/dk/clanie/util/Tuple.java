...
public abstract class Tuple implements Comparable<Tuple> {
	 ...
	 * @return Quadruple
	 */
	public static <T1, T2, T3, T4> Quadruple<T1, T2, T3, T4> newTuple(
	 ...
	 * @return Quintuple
	 */
	public static <T1, T2, T3, T4, T5> Quintuple<T1, T2, T3, T4, T5> newTuple(
	 ...
	 * @return Sextuple
	 */
	public static <T1, T2, T3, T4, T5, T6> Sextuple<T1, T2, T3, T4, T5, T6> newTuple(
